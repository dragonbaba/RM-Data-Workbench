            ...
            <div className="grid grid-cols-4 gap-x-4 gap-y-4">
              ...
              {shouldShowTargetCount ? (
                <Form.Item
                  ...
                  className="mb-0"
                >
                  <InputNumber min={1} step={1} className="w-full" disabled={!isOverrideEnabled} />
                </Form.Item>
              ) : null}
              <Form.Item
              ...
              <Form.Item
                ...
                className="mb-0"
              >
                <InputNumber min={0} step={0.01} className="w-full" disabled={!isOverrideEnabled} />
              </Form.Item>
              <Form.Item
              ...
              <Form.Item
                ...
                className="mb-0"
              >
                <InputNumber min={0} step={1} className="w-full" disabled={!isOverrideEnabled} />
              </Form.Item>
            </div>
